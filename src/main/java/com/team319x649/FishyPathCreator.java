...
public class FishyPathCreator extends AbstractFishyPathCreator {
	...
	private FishyPath getIanAssistPathLeft() {
		...
		ianAssistLeft.addWaypointRelative(3, 0, 0, 6, 6, true, true); 
		ianAssistLeft.addWaypoint(25, 22.8, -20, 0, 8, true, true);
	...
	private FishyPath getIanAssistPathRightTurn() {
		...
		ianAssistRight.addWaypoint(new Waypoint(5.5, 27 - 17.354167, 0, 0, 0));
		ianAssistRight.addWaypointRelative(4.5, 0, 0, 6, 6, true, true); // go off HAB1 with max speed of 3 ft/s. waiting on specs from HW team for max speed off HAB2.
		ianAssistRight.addWaypoint(25, 27 - 22.8, 20, 0, 8, true, true);
		return ianAssistRight;
	}
	...
	private FishyPath getBackRocketDriveInLeft() {
		...
		ianAssistLeft.addWaypoint(20, 26, -30, 0, 4, false, true);
		return ianAssistLeft;
	}
	...
	private FishyPath getBackRocketDriveInRight() {
		...
		ianAssistLeft.addWaypoint(20, 2, 30, 0, 4, false, true);
		return ianAssistLeft;
	}
	...
	private FishyPath getFarCargoLeft() {
		...
		leftNearCargoShip.addWaypoint(new Waypoint(5.5, 17.354167, 0, 0, 0, true, true));
		leftNearCargoShip.addWaypointRelative(4.5, 0, 0, 4, 4, true, true);
		leftNearCargoShip.addWaypoint(17, 19, 0, 4, 4, true, true);
		leftNearCargoShip.addWaypoint(25, 23, 89, 0, 4, true, true);
		leftNearCargoShip.addWaypoint(25.5, 18, 89, 0, 4, true, false);
		return leftNearCargoShip;
	}
	...
	private FishyPath getFarCargoLeftToLSL() {
		...
		leftCargoToLSL.addWaypoint(25, 25, 89, 0, 4, true, true);
		leftCargoToLSL.addWaypoint(17, 20, 0, 4, 4, false, true);
		leftCargoToLSL.addWaypoint(2.5, 24.75, 0, 0, 4, false, false);
	...
	private FishyPath getLSLToCargoMid() {
		...
		leftNearCargoShip.addWaypoint(20, 20, 0, 4, 4, true, true);
		leftNearCargoShip.addWaypoint(23, 23, 89, 0, 4, true, true);
		leftNearCargoShip.addWaypoint(23.5, 18, 89, 0, 4, true, true);
		return leftNearCargoShip;
	}

...
public class DrivetrainSubsystem extends Subsystem implements ILogger {
  ...
  public DrivetrainSubsystem() {
    ...
    motors[0].config_kF(0, 0.5, 200);
    motors[0].config_kP(0, 1.4, 200);
    motors[0].config_kI(0, 0.000, 200);
    motors[0].config_IntegralZone(0, (int) (FishyMath.rpm2talonunits(FishyMath.fps2rpm(5.0))), 200);
    motors[0].config_kD(0, 3.0, 200);
    ...
    motors[3].config_kF(0, 0.51);
    motors[3].config_kP(0, 1.4);
    motors[3].config_kI(0, 0.000);
    motors[3].config_IntegralZone(0, (int) (FishyMath.rpm2talonunits(FishyMath.fps2rpm(5.0))));
    motors[3].config_kD(0, 3.0);

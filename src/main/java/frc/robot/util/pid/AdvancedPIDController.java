 ...
 */
public class AdvancedPIDController extends AdvancedPIDBase implements Controller {
  ...
  public AdvancedPIDController(double Kp, double Ki, double Kd, double Kf, PIDSource source,
   ...
   */
  @SuppressWarnings("ParameterName")
  public AdvancedPIDController(double Kp, double Ki, double Kd, PIDSource source, PIDOutput output,
                       double period) {

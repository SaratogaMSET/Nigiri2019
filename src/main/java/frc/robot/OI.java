...
public class OI {
  ...
  public class Driver {
    private JoystickFilter verticalFilter = new JoystickFilter(0.03, 0.0, 1.0, Mode.LINEAR);
    private JoystickFilter horizontalFilter = new JoystickFilter(0.03, 0.0, 1.0, Mode.SQUARED);

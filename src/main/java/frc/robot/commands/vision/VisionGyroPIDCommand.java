...
public class VisionGyroPIDCommand extends Command {
  ...
  public VisionGyroPIDCommand(double timeout) {
  ...
  protected void initialize() {
    ...
    pidController.setSetpoint(Robot.gyro.getGyroAngle());
  ...
  protected void execute() {
    ...
    if(angleSet || angle == null || (distance != null && distance < 30.0)) {
      ...
      pidController.setSetpoint(Pathfinder.boundHalfDegrees(Robot.gyro.getGyroAngle() + angle));
